...
namespace StockTrackingApp.Business.Services
{
    public class ApiUserService : IApiUserService
    {
        ...
        public ApiUserService(IApiUserRepository apiUserRepository, IMapper mapper, IAccountService accountService, UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<IDataResult<ApiUserDto>> AddAsync(ApiUserCreateDto createApiUserDto)
        {
        ...
        public async Task<IDataResult<ApiUserDto>> UpdateAsync(ApiUserUpdateDto updateApiUserDto)
        {
