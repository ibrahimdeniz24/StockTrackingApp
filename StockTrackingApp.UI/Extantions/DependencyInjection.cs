...
using StockTrackingApp.UI.Authorization;
    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddHangfire(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddHangfire(config =>
            {
                ...
                config.UseSqlServerStorage(configuration.GetConnectionString(StockAppDbContext.ConnectionName), option).WithJobExpirationTimeout(TimeSpan.FromHours(6));
            });
